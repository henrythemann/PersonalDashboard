...
export default async function handler(req: any, res: any) {
  try {
    ...
    const result = await client.query('INSERT INTO public.events (start_time, end_time, title, color) VALUES ($1, $2, $3, $4)', [req.query.start_time, req.query.end_time, req.query.title, req.query.color || 'ffb300']);
